...
<head>
    ...
    <body>
        <form action="">
            ...
            <input type="radio" name="Atributo" id="Atributo" value="Expedicion">Fecha de Expedición
            <input type="radio" name="Atributo" id="Atributo" value="Vencimiento">Fecha de Vencimiento
            <input type="radio" name="Atributo" id="Atributo" value="Numero">Número
            <input type="radio" name="Atributo" id="Atributo" value="Tipo">Tipo
            <input type="radio" name="Atributo" id="Atributo" value="ConductorID">ID de Conductor
            <input type="submit">
        </form>
