...
<head>
    ...
    <body>
        <form action="">
            ...
            <input type="radio" name="Atributo" id="Atributo" value="FechaExpedicion">Fecha de Expedición
            <input type="radio" name="Atributo" id="Atributo" value="FechaVencimiento">Fecha de Vencimiento
