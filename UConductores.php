...
<head>
    ...
    <body>
        ...
        if(isset($_POST['ID'])){
            ...
            $Fila=mysqli_fetch_row($ResultSet);
                ...
                <form method="POST">
                    ...
                    <input type="submit" name="actualizar_conductor" value="Actualizar">
                </form>
                <?php
            Desconectar($Con);
        }
        ...
        if(isset($_POST['actualizar_conductor'])){
            ...
            $Con=Conectar();
            $SQL="UPDATE conductores SET Nombre='$Nombre', Apellidos='$Apellidos', FechaNac='$FechaNac', Genero='$Genero', Telefono='$Telefono', Correo='$Correo', DireccionID='$DireccionID' WHERE ID='$ID';";
            $ResultSet=Ejecutar($Con,$SQL);
            Desconectar($Con);
