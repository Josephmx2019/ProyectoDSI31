...
<head>
    ...
    <body>
        <form action="">
            ...
            <input type="radio" name="Atributo" id="Atributo" value="FechaNac">Fecha de Nacimiento
            <input type="radio" name="Atributo" id="Atributo" value="Genero">Género
        ...
        <?php
            if(isset($_REQUEST['Valor'])){
                ...
                $SQL="SELECT * FROM propietario WHERE $Atributo LIKE '%$Valor%'";
